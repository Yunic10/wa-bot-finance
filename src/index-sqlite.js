...
const MessageHandler = require('./handlers/messageHandler-sqlite');
...
class WhatsAppFinanceBot {
  ...
  async initialize() {
    try {
      console.log('🚀 Initializing WhatsApp Finance Bot (SQLite)...');
      ...
      console.log('✅ WhatsApp Finance Bot (SQLite) initialized successfully');
